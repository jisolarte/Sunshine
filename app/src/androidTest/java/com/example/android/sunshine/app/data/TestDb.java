...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Not match!", cursor,TestUtilities.createNorthPoleLocationValues());
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error insterting in Weather Table", weatherId!=-1);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Nigga you baad",cursor,contentValues);
